...
AS $$
DECLARE
  project_url TEXT := 'https://rihboifsnscnqushbgjc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJpaGJvaWZzbnNjbnF1c2hiZ2pjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0Nzc2NDk1MiwiZXhwIjoyMDYzMzQwOTUyfQ.yfMqMm9-fQVbpJtiCjCJY0s6tskllJgNBiNFFJ8sS6U'; -- full access needed for http request to storage
