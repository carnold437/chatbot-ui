...
AS $$
DECLARE
  project_url TEXT := 'https://utpuzzlcjtlrjoqzgfgr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InV0cHV6emxjanRscmpvcXpnZmdyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0Nzc3MzI0NCwiZXhwIjoyMDYzMzQ5MjQ0fQ.QsEJzx-2n8zfAgeSxcL0aXZWbHcWjYUH464UZVuZSgc'; -- full access needed for http request to storage
